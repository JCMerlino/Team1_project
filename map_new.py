...
room_reception = {
    ...
    "description":
    """Jenifer's office outside of Samantha's Office. Jenifer is sitting at her 
    desk.""",

    "inspection":
    """Jenifer's office? I didn't think she got paid enough to earn herself an 
    office. She has a basic desk and a virus filled computer. Not that she even 
    uses them. She's also put her makeup everywhere. Does she actually do work? 
    Who knows... She's currently pretending to do something on the computer. 
    Probably playing some stupid game to pass the time. What else is here... 
    waste bin, fan, ink cartridges, window... yeah nothing else of importance.""",
...
room_samantha = {
    ...
    "description":
    """The Boss' office is large and filed with custom made furniture and has 
    expensive carpet. The first floor windows provide natural lighting and a 
    view over the street below. Samantha is sitting at her desk.""",

    "inspection":
    """Samantha's Office... The place where paychecks are crushed and lives 
    are disregarded. Her large desk is shadowed only by her larger bookcase, 
    probably compensating for her failing secret service. The computer is 
    heavily used as shown by her sixth replacement keyboard this week and 
    her secret alcohol stash is always hidden under her desk but it's not 
...
room_armoury = {
    ...
    "description":
    """The Armoury is where all registered weapons are stored. Only field 
    agents are cleared to enter and each agent is assigned a unique code 
    to enter the armoury.""",

    "inspection":
    """This is where the big boy toys are kept. On more than one occasion 
    the beauties from this place have gotten me out of some sticky situations. 
    We got assault rifles, submachine guns, shotguns, grenades and all kinds 
    of stuff here. My personal favourite is the suppressed pistol because it 
    makes the cool psst sound when you shoot it. Speaking of which... I can't 
    find it. Its missing from the rack but no one has logged it out...WHO'S 
    TAKEN MY GUN? I used that to shoot enough people that I can somewhat 
    unofficially claim it as my own.""",
...
room_stairs2 = {
    ...
    "description":
    """Stairs that lead from the ground floor to the first floor and 
    basement.""",

    "inspection":
    """Whilst I hate stairs I can say that out of all of them these stairs 
    are the worst. If you're going up you're either getting fired or getting 
    shot at and if you're going down its because someone cough* Stephen cough* 
    sent you down their against your own will because he's too lazy to do 
    errands himself. Either way you only use these stairs if someone else 
    wants you to.""",
...
room_office_debra = {
    ...
    "description":
    """The ground floor office that connects used rooms to the floor. The 
    break room and science labs are connected to this part of the office.""",
    ...
    attached to her computer. It's a safety complaint waiting to happen. Yet she
    spends most of her time complaining about my unorganised and terrible ways of
    doing things. Thing is I get things done, even if I may accidently kill a 
    few people here and there whilst doing it.""",
...
room_science = {
    ...
    "description":
    """The Science Lab is filled with technology beyond normal comprehension. 
    The Science Lab has direct access to the storage room. Stephen sits at 
    his lab desk""",

    "inspection":
    """Science Lab is a fancy name for Stephen's backstreet workshop. He once 
...
room_break = {
    ...
    "description":
    """The break room is a medium sized room with a few tables and chairs as
    well as a small kitchen area. Debra is standing by the kitchen area""",
    ...
    this morning. Someone needs to talk to her about her eating habits. 
    She's also got that awful mug Jenifer bought her. Those two gossip like 
    socially deprived mothers. You know. The ones who have a coffee with other
    mums for the whole day. They bought matching BFF mugs but they are much 
    closer than that. Unless anyone told you otherwise, you'd assume they 
    were a couple. Which apparently they don't mind because: "If there isn't 
    a rumour you're gay for each other, you're not real BFFs" which I don't 
    understand but hey if they want to keep their relationship a "secret" 
    who am I to judge or say otherwise.""",
...
room_meeting = {
    ...
    "description":
    """The meeting room is where all important meetings take place. There 
    is a large rectangular table with chairs all around and a projector 
...
room_office_bob = {
    ...
    "description":
    """The ground floor office that connects used rooms to the floor. 
    The meeting room, toilets and storage room are connected to this part 
    of the office.""",
...
room_storage = {
    ...
    "description":
    """The storage room is for general storage that isn't of high enough 
    importance to be locked in the vault. The room contains many shelves 
    and containers where all matter of items are kept.""",

    "inspection":
    """If I had a penny for every time I lost an item in here I'd probably 
    be a millionaire. This is supposed to be an area for work related storage 
...
room_stairs3 = {
    ...
    "inspection":
    """You'd think that the stairs to hell would be going down, but in this case 
    they lead up. Down here no one can bother you or tell you to work. """,
...
room_hallway_east = {
    ...
    "description":
    """The hallway of the basement connects the three important rooms to the stairs. 
    The backup generator room can be accessed from this part of the hallway""",
...
room_generator = {
    ...
    "description":
    """The backup generator room is a large room riddled with Stephen's technology 
    turning a medium sized generator into the backup for the entire building.""",

    "inspection":
    """This room has seen better days. I liked it better when it was the 
    interrogation room. There's still some blood where the stains won't come off the 
    floor. Good times... Wait. My pistol is in the corner of the room. Someone tried 
    to tuck it away behind the generator. How did it get here? """,
...
room_hallway_west = {
    ...
    "description":
    """The hallway of the basement connects the three important rooms to the stairs. 
    The mainframe and vault can be accessed from this part of the hallway""",
...
room_vault = {
    ...
    but there are some interesting stories to how some of these items got here. 
    Including this interesting piece of tech. I have no idea what it is but it's blinking 
    so it's either a bomb or a communicator. But why is it here? I should probably ask 
    Stephen about it but then again Debra might want to know if something fishy is going 
    on. More importantly my secrets box looks unopened so I think they are safe.""",
